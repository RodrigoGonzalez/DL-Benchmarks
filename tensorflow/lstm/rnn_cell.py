# This source code is from TensorFlow project
#   https://github.com/tensorflow/tensorflow
# Copyright (c) 2015 Google Inc. All Rights Reserved.
# This source code is licensed under the Apache-2.0 license found in the
# 3rd-party-licenses.txt file in the root directory of this source tree.

# The original code was modified by Robert Bosch LLC, USA to add masking
# for LSTM layer.
...
class BasicLSTMCellMask(RNNCell):
  """LSTM recurrent network cell with masking.

  The implementation is similar to the IMDB tutorial example from Theano
